...
public class JsonApp {
    ...
    public static void GenerateReportOneThreeAndFour(Properties usersFile, String apiUrl, String username, String password) throws ParseException {
        ...
        try {
            ...
            String urlReport1 = apiUrl + "/entities/_total?filter=" + URLEncoder.encode(url + ") and range (updatedTime," + start_date + "," + end_date + "))", "utf-8");
            ...
            String total1 = responseToJsonObject1.get("total").getAsString();
            String stDt = startDate.replaceAll("/", "");
            String enDt = endDate.replaceAll("/", "");
            String outputFileName= "C:/Sourav/Report1_3_4From_" + stDt + "_To_" + enDt + ".csv";
...
BufferedWriter outputFileWriter = new BufferedWriter(new FileWriter(outputFileName));           
            ...
            saveReportOneThreeAndFourAsCsv(header,total1,outputFileWriter);
    ...
    public static void GenerateReport2(Properties usersFile, String apiUrl, String username, String password) {
        ...
        try {
            ...
            String stDt = startDate.replaceAll("/", "");
            String enDt = endDate.replaceAll("/", "");
            String outputFileName = "C:/Sourav/Report2_From_" + stDt + "_To_" + enDt + ".csv";
    ...
    public static void saveReportOneThreeAndFourAsCsv(String header,String total1, BufferedWriter outputFileWriter) throws IOException {
 
                     
                outputFileWriter.write(header);
                outputFileWriter.write(total1 + "\n");
